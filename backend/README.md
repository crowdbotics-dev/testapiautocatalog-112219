...
## Project Structure
    ...
    ├── testapiautocatalog_112219  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112219`
...
2. Clone this repo and `cd testapiautocatalog_112219`
